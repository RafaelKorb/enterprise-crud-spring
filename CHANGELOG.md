...
- API REST de contas: `POST /accounts`, `GET /accounts/{id}`, `GET /accounts` (cursor), `POST /accounts/{id}/credits`, `POST /accounts/{id}/debits` e `PUT /accounts/{id}/status`, com mapeamento MapStruct e erros em Problem Details (RFC 9457).
